...
public class DeleteUserRunner {
	...
	public void testUserDelete() {
		...
		driver.findElement(By.xpath("//mat-dialog-actions/button[1]/span[2]")).click();

	}

	public static void main(String[] args) {
		
		DeleteUserRunner deleteUser = new DeleteUserRunner();
		deleteUser.loadGoolgePage();
		deleteUser.testUserDelete();
